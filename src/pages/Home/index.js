...
const Page = () => {
  ...
  // const last => which comes to get the last service in the footer
  const last =
  data && data.events && data.events.length > 0
      ? data.events[data.events.length - 1]
      : null;

// Add "( ... )" for the return, because he didn't have it.
  return ( 
  <>
    <header>
      <Menu />
    ...
    <main>
      ...
      <section className="ServicesContainer">
        {/* add anchor link id="nos-services" */}
      ...
      <section className="EventsContainer">
        {/* add anchor link id="nos-realisations" */}
        <h2 className="Title" id="nos-realisations">Nos réalisations</h2>
        <EventList />
      </section>
      <section className="PeoplesContainer">
        {/* add anchor link id="notre-equipe" */}
